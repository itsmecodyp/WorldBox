...
namespace SimpleAdditions {
	class aItems {
		...
		public static void AddItems()
		{
			...
			newWeaponsIcons.Add(blueSword1.materials[0], LoadSprite(Resources.bluesword1, 0, 0, 0f, 0f));
			...
			newWeaponsIcons.Add(blueSword2.materials[0], LoadSprite(Resources.bluesword2, 16, 16, 0f, 0f));
			...
			newWeaponsIcons.Add(blueSword3.materials[0], LoadSprite(Resources.bluesword3, 16, 16, 0f, 0f));
		}
